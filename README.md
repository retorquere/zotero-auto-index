...
Install by downloading the [latest version](https://raw.github.com/friflaj/zotero-auto-index/master/zotero-auto-index-0.0.25.xpi).
...
or support requests on anything but the latest version, currently at **0.0.25**. If you submit an issue report,
